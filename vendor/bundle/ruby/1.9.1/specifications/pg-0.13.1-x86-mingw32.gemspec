...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["Manifest.txt", "History.rdoc", "README-OS_X.rdoc", "README.rdoc", "Contributors.rdoc", "README-Windows.rdoc", "README.ja.rdoc", "POSTGRES", "LICENSE", "ext/pg_connection.c", "ext/pg.c", "ext/pg_result.c"]
  s.files = ["Manifest.txt", "History.rdoc", "README-OS_X.rdoc", "README.rdoc", "Contributors.rdoc", "README-Windows.rdoc", "README.ja.rdoc", "POSTGRES", "LICENSE", "ext/pg_connection.c", "ext/pg.c", "ext/pg_result.c"]
